...
<div wire:init="loadInitial">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="relative">
            @if($refreshing)
                <div class="absolute inset-0 bg-black/50 backdrop-blur-sm z-20 flex items-center justify-center">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                ...
                <div wire:loading wire:target="loadDramas" class="col-span-full">
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                        @for($i = 0; $i < 5; $i++)
                            <div class="rounded-2xl overflow-hidden shimmer">
                                <div class="rounded-2xl overflow-hidden shimmer">
